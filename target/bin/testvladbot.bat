...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="testvladbot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" bot.Bot %CMD_LINE_ARGS%
